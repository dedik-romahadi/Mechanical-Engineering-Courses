...
<div style="background:#06091a;border:1px solid rgba(255,255,255,.07);border-radius:8px;padding:10px 12px;width:312px;max-width:100%;margin:0 auto">
<svg viewBox="0 0 540 300" preserveAspectRatio="xMidYMid meet" style="display:block;margin:0 auto;width:288px;height:160px;max-width:100%">
