...
<div style="margin-top:10px">**Sinyal multi-komponen (mesin nyata):**</div>

$$\Large x(t) = \sum_{k} A_k\cos(\omega_k t + \phi_k) + n(t)$$

<div style="margin-top:6px;font-size:12px;color:#94a3b8">di mana $n(t)$ = noise acak terukur</div>

<div style="background:#0d1526;border:1px solid rgba(255,255,255,.08);border-radius:8px;padding:10px 12px;margin-top:16px">
