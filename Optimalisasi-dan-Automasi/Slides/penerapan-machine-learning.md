...
<div style="color:#94a3b8;font-size:12px;margin-bottom:3px;text-align:center">Tiap titik = satu mesin, diplot pada 2 fitur. Geser <b>garis batas keputusan</b> (slider) dan amati akurasinya — inilah inti kerja sebuah <i>classifier</i>.</div>

<FeatureScatter />

<div style="margin-top:4px;font-size:12px;color:#94a3b8;text-align:center;padding-right:70px">
...
<div class="alg-intro">Data sama, tapi <b>batas keputusan</b> tiap algoritma beda bentuknya:</div>

<div class="alg-strip">
  <div class="alg-cell"><svg class="alg-svg" viewBox="0 0 104 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><g fill="#34d399"><circle cx="16" cy="44" r="3"/><circle cx="26" cy="50" r="3"/><circle cx="22" cy="38" r="3"/><circle cx="34" cy="47" r="3"/><circle cx="13" cy="53" r="3"/></g><g fill="#fb7185"><circle cx="74" cy="20" r="3"/><circle cx="84" cy="26" r="3"/><circle cx="78" cy="13" r="3"/><circle cx="88" cy="31" r="3"/><circle cx="70" cy="23" r="3"/></g><path class="bnd" d="M52,3 C46,15 60,21 52,31 C44,41 60,47 52,57" fill="none" stroke="#a78bfa" stroke-width="2.2" stroke-linecap="round"/></svg><div class="alg-lb s">📍 k-NN</div><div class="alg-sub">Batas Lokal Berkelok</div></div>
  <div class="alg-cell"><svg class="alg-svg" viewBox="0 0 104 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><g fill="#34d399"><circle cx="16" cy="44" r="3"/><circle cx="26" cy="50" r="3"/><circle cx="22" cy="38" r="3"/><circle cx="34" cy="47" r="3"/><circle cx="13" cy="53" r="3"/></g><g fill="#fb7185"><circle cx="74" cy="20" r="3"/><circle cx="84" cy="26" r="3"/><circle cx="78" cy="13" r="3"/><circle cx="88" cy="31" r="3"/><circle cx="70" cy="23" r="3"/></g><path class="bnd" d="M42,3 L42,25 L60,25 L60,41 L78,41 L78,57" fill="none" stroke="#a78bfa" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"/></svg><div class="alg-lb a">🌳 Decision Tree</div><div class="alg-sub">Kotak Bertingkat</div></div>
  <div class="alg-cell"><svg class="alg-svg" viewBox="0 0 104 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><g fill="#34d399"><circle cx="16" cy="44" r="3"/><circle cx="26" cy="50" r="3"/><circle cx="22" cy="38" r="3"/><circle cx="34" cy="47" r="3"/><circle cx="13" cy="53" r="3"/></g><g fill="#fb7185"><circle cx="74" cy="20" r="3"/><circle cx="84" cy="26" r="3"/><circle cx="78" cy="13" r="3"/><circle cx="88" cy="31" r="3"/><circle cx="70" cy="23" r="3"/></g><path class="bnd" d="M44,3 L44,15 L52,15 L52,25 L60,25 L60,35 L70,35 L70,45 L80,45 L80,57" fill="none" stroke="#a78bfa" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"/></svg><div class="alg-lb e">🌲 Random Forest</div><div class="alg-sub">Ensembel Lebih Halus</div></div>
  <div class="alg-cell"><svg class="alg-svg" viewBox="0 0 104 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><g fill="#34d399"><circle cx="16" cy="44" r="3"/><circle cx="26" cy="50" r="3"/><circle cx="22" cy="38" r="3"/><circle cx="34" cy="47" r="3"/><circle cx="13" cy="53" r="3"/></g><g fill="#fb7185"><circle cx="74" cy="20" r="3"/><circle cx="84" cy="26" r="3"/><circle cx="78" cy="13" r="3"/><circle cx="88" cy="31" r="3"/><circle cx="70" cy="23" r="3"/></g><path d="M46,3 L70,59 M34,7 L58,63" fill="none" stroke="#a78bfa" stroke-width="1" stroke-dasharray="3 3" opacity="0.5"/><path class="bnd" d="M40,5 L64,61" fill="none" stroke="#a78bfa" stroke-width="2.2" stroke-linecap="round"/></svg><div class="alg-lb v">🎯 SVM</div><div class="alg-sub">Garis Margin Maksimum</div></div>
</div>
