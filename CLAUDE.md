...
| `Teknik-Tenaga-Listrik/` | `teknik_tenaga_listrik` | `teknik_tenaga_listrik-modul-N` (terbit: Modul 1–6) | TTL |
...
- **Akun simulasi** NIM `41399999901` ("SIMULASI MAHASISWA") — akun uji
  ...
  - daftar NIM-nya harus sama di dua tempat: `SIM_NIMS` di backend
    ...
    (disuntikkan ke 70 halaman modul/exam + 4 halaman OBE); nama ada di lima `students.json` **dan**
