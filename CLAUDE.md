...
| `Pemodelan-Computer-Aided-Design/` | `pemodelan_cad` | `pemodelan_cad-modul-N` (terbit: Modul 1–5; tugas berkas FreeCAD) | CAD |
...
Total berkas HTML utama: **75 modul + 10 exam + 6 OBE**. Pemodelan CAD: Modul 1–5
