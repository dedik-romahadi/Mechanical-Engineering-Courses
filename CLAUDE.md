...
| `Pemodelan-Computer-Aided-Design/` | `pemodelan_cad` | `pemodelan_cad-modul-N` (terbit: Modul 1–2; tugas berkas FreeCAD) | CAD |
...
Total berkas HTML utama: **72 modul + 10 exam + 6 OBE**. Pemodelan CAD: Modul 1–2
