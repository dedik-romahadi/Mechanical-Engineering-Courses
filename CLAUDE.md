...
| `Pemodelan-Computer-Aided-Design/` | `pemodelan_cad` | `pemodelan_cad-modul-N` (terbit: Modul 1–3; tugas berkas FreeCAD) | CAD |
...
Total berkas HTML utama: **73 modul + 10 exam + 6 OBE**. Pemodelan CAD: Modul 1–3
