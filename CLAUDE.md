...
| `Pemodelan-Computer-Aided-Design/` | `pemodelan_cad` | `pemodelan_cad-modul-N` (terbit: Modul 1–4; tugas berkas FreeCAD) | CAD |
...
Total berkas HTML utama: **74 modul + 10 exam + 6 OBE**. Pemodelan CAD: Modul 1–4
