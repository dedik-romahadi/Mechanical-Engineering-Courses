...
- Validator: TTL tetap di `obeOnlyRoots` validator keamanan (belum ada Exam); `validate-all-course-modern-design.mjs` memeriksanya lewat `moduleCount` (sekarang 6). Hitungan: 62 modul dengan tombol ekspor terjaga dan 81 halaman ber-autentikasi admin.
