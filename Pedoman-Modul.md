...
- 65 modul: 14 per course aktif + Modul 1–9 Teknik Tenaga Listrik;
...
| Teknik Tenaga Listrik | `teknik_tenaga_listrik-modul-N` (terbit: N = 1–9) |
...
Seluruh 65 modul memakai editor deadline berupa field tanggal dan field teks jam
...
|---|---|
| `validate-all-course-modern-design.mjs` | Marker, runtime, tabel, kartu pustaka, perilaku tab, editor deadline `HH:mm` 24 jam, normalisasi WIB, dan sintaks pada seluruh 65 modul (Teknik Tenaga Listrik sebatas modul yang sudah terbit). |
