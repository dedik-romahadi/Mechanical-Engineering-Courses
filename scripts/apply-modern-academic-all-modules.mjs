...
@media screen{
  ...
  .academic-roadmap .road-step{flex:1;min-width:0;display:grid;grid-template-columns:auto 1fr;column-gap:14px;align-items:center;padding:16px 18px;border:1px solid rgba(148,163,184,.14);border-radius:14px;background:rgba(4,10,20,.45);text-align:left;animation:motionRoadFloat 5.6s ease-in-out infinite}
  .academic-roadmap .road-step>span{grid-row:1/3;display:grid;place-items:center;width:42px;height:42px;border-radius:11px;background:rgba(34,211,238,.1);border:1px solid rgba(34,211,238,.25);font:700 14px 'JetBrains Mono',monospace;color:#67e8f9}
  ...
  .academic-roadmap strong{font-size:17px;color:#f8fafc;letter-spacing:.02em}.academic-roadmap small{font-size:13.5px;color:#a3b1c6;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  .academic-roadmap .road-arrow{align-self:center;color:#94a3b8;font:700 28px 'JetBrains Mono',monospace;animation:motionArrowFlow 1.8s ease-in-out infinite}
  ...
  #page-modul .formula-block .formula-main{font-size:clamp(16px,1.5vw,18px);line-height:1.7;font-weight:600;color:#e6f8ff;text-shadow:0 0 18px rgba(103,232,249,.12);transition:color .3s ease,text-shadow .3s ease,filter .3s ease}.formula-main .katex{display:inline-block;margin:0}.formula-main br+.katex{margin-top:.8em}
  ...
  #page-modul .tbl-wrap.academic-table-wrap{--table-caption-indent:24px;position:relative;margin:22px 0 30px!important;overflow-x:auto;border:1px solid rgba(148,163,184,.2);background:linear-gradient(160deg,rgba(11,20,33,.98),rgba(6,12,21,.98));box-shadow:0 22px 48px -28px rgba(0,0,0,.96),inset 0 1px 0 rgba(255,255,255,.04);scrollbar-width:thin;scrollbar-color:var(--chapter-accent,#22d3ee) rgba(8,15,27,.9)}
  ...
  #page-modul .tbl-wrap table.academic-data-table .table-caption{caption-side:top;box-sizing:border-box;height:50px;max-height:50px;padding:0 var(--table-caption-indent);overflow:hidden;background:linear-gradient(90deg,#0d3b4a,#25205f 58%,#3b155c);border-bottom:1px solid #38577e;color:#dff7ff;font:700 11px/50px 'JetBrains Mono',monospace;letter-spacing:1.25px;text-align:left;text-transform:uppercase;white-space:nowrap}
  #page-modul .tbl-wrap .table-caption .anim-dot{display:inline-block;width:8px;height:8px;margin-right:10px;border-radius:50%;background:var(--chapter-accent,#22d3ee);box-shadow:0 0 12px var(--chapter-accent,#22d3ee);vertical-align:middle}#page-modul .tbl-wrap .table-caption .anim-title{display:inline-block;max-width:calc(100% - 30px);overflow:hidden;color:#e6f8ff;line-height:1.55;text-overflow:ellipsis;vertical-align:middle;white-space:nowrap}
  ...
  #page-modul .tbl-wrap table.academic-data-table.has-equation-column{table-layout:auto;min-width:max(var(--academic-table-min,820px),100%)}
  #page-modul .tbl-wrap table.academic-data-table .equation-column{width:1%;min-width:180px;overflow-wrap:normal;white-space:nowrap;word-break:normal}
  #page-modul .tbl-wrap table.academic-data-table td.equation-column{background:linear-gradient(135deg,rgba(34,211,238,.055),rgba(168,85,247,.045));color:#eefaff;font-family:'JetBrains Mono',monospace;font-size:.96rem}
...
@media screen and (max-width:700px){
  ...
  #page-modul .tbl-wrap table.academic-data-table .table-caption{height:50px;max-height:50px;padding:0 var(--table-caption-indent);font-size:10px;line-height:50px;letter-spacing:1px}#page-modul .tbl-wrap table.academic-data-table thead th{padding:12px 14px;font-size:10px;letter-spacing:1px}#page-modul .tbl-wrap table.academic-data-table tbody td{padding:12px 14px;font-size:.86rem}#page-modul .tbl-wrap table.academic-data-table .equation-column{min-width:180px}
}
