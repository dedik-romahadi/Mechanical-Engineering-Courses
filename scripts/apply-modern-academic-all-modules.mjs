...
@media screen{
  ...
  #page-modul .formula-block .formula-main{font-size:clamp(16px,1.5vw,18px);line-height:1.7;font-weight:600;color:#e6f8ff;text-shadow:0 0 18px rgba(103,232,249,.12);transition:color .3s ease,text-shadow .3s ease,filter .3s ease}.formula-main br+span{display:inline-block;margin-top:.8em}
