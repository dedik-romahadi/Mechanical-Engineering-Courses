...
@media screen{
  ...
  #page-modul .tbl-wrap table.academic-data-table .table-caption{caption-side:top;box-sizing:border-box;height:50px;max-height:50px;padding:0 24px;overflow:hidden;background:linear-gradient(90deg,#0d3b4a,#25205f 58%,#3b155c);border-bottom:1px solid #38577e;color:#dff7ff;font:700 11px/50px 'JetBrains Mono',monospace;letter-spacing:1.25px;text-align:left;text-transform:uppercase;white-space:nowrap}
