...
for (let n = 1; n <= 14; n += 1) {
  ...
  checks.push(
    ...
    [html.includes(".score-bar-compact .btn-export{padding:9px 16px;min-height:38px") && html.includes(".score-bar-compact #export-blocked-msg{font-size:10.5px!important;line-height:1.3}"), "tombol dan pesan panel skor diringkas"],
