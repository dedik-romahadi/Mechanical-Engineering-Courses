...
/* Tombol bisu: kecil, menempel di pojok kanan-bawah, di atas konten tetapi di
   bawah overlay login (z-index overlay halaman 100000+). */
.ej-tombol-bisu{position:fixed;right:14px;bottom:14px;z-index:9000;width:40px;height:40px;border-radius:50%;border:1px solid rgba(148,163,184,.35);background:rgba(15,23,42,.82);color:#fff;font-size:18px;line-height:1;cursor:pointer;box-shadow:0 4px 14px rgba(0,0,0,.28);backdrop-filter:blur(6px);transition:transform .15s ease,opacity .2s ease;opacity:.85}
