...
const DARING = {
  numerik: 'dokumentasi <code style="font-family:\'JetBrains Mono\',monospace;color:var(--cyan)">numpy</code> dan <code style="font-family:\'JetBrains Mono\',monospace;color:var(--cyan)">scipy.signal</code> berguna untuk memverifikasi hasil hitungan tangan Anda. Untuk tugas modul ini cukup pakai <code style="font-family:\'JetBrains Mono\',monospace;color:var(--cyan)">numpy</code> — tujuannya melatih penurunan rumus, bukan memanggil pustaka siap pakai.',
  kontrol: 'dokumentasi <code style="font-family:\'JetBrains Mono\',monospace;color:var(--cyan)">python-control</code> memuat contoh yang setara dengan pembahasan modul ini. Pakai untuk memeriksa jawaban, bukan untuk menggantikan penurunannya — soal komputasi menilai angka yang Anda cetak, dan angka itu harus bisa Anda pertanggungjawabkan.',
...
export const PUSTAKA = {
  2: {
    ...
    ref: [
      [B.nise, "Bab 1 dan 4 — spesifikasi respons transien beserta cara menerjemahkan kebutuhan operasi menjadi angka yang dapat diuji."],
      [B.franklin, "Bab 3 dan 4 — hubungan spesifikasi dengan letak pole yang harus dicapai; dasar penurunan pada modul ini."],
      [B.skogestad, "Bab 1-2 — mengapa spesifikasi selalu mengandung pertukaran, dan bagaimana batas fisik membatasi yang boleh dituntut."],
      [B.astrom, "Bab 1 dan 12 — kerangka berpikir perancangan umpan balik beserta batas yang tidak dapat dilanggar rancangan apa pun."],
      [B.isermann, "Bab 1 — analisis bahaya dan lapisan perlindungan; dibaca sebelum menetapkan lapisan alarm dan interlock."],
    ],
  },
  3: {
    ...
    ref: [
      [B.ogata, "Bab 2 — Mathematical Modeling of Control Systems; tabel pasangan transformasi dan sifat-sifatnya."],
      [B.nise, "Bab 2 — Modeling in the Frequency Domain; banyak contoh terselesaikan yang setara dengan soal komputasi modul ini."],
      [B.dorf, "Bab 2 — Mathematical Models of Systems; penekanan pada arti fisik tiap suku, bukan sekadar manipulasi aljabar."],
  ...
  4: {
    ...
    daring: DARING.kontrol,
    ref: [
      [B.nise, "Bab 5 — Reduction of Multiple Subsystems; aturan seri, paralel, dan umpan balik beserta latihannya."],
      [B.ogata, "Bab 3 — Mathematical Modeling of Mechanical and Electrical Systems; penurunan fungsi transfer dari hukum fisika."],
      [B.dorf, "Bab 2 dan 5 — pengaruh pole dominan dan zero terhadap respons, termasuk gejala fase non-minimum."],
      [B.franklin, "Bab 3 — Dynamic Response; hubungan letak pole dengan bentuk respons yang dipakai di seluruh modul ini."],
  ...
  5: {
    ...
    daring: DARING.numerik,
    ref: [
      [B.ljung, "Bab 1-6 — identifikasi sistem dari data uji; dasar penentuan gain statik, konstanta waktu, dan dead time."],
      [B.seborg, "Bab 5-7 — pemodelan proses dan uji step di lapangan; contohnya dekat dengan praktik industri."],
      [B.franklin, "Bab 3 dan 8 — pengaruh pencuplikan dan langkah waktu terhadap kesahihan hasil simulasi."],
  ...
  6: {
    ...
    ref: [
      ...
      [B.franklin, "Bab 4 — analisis kinerja lingkar tertutup yang menjadi isi tiap titik pada kurva sapuan."],
    ],
  },
  7: {
    ...
    daring: DARING.numerik,
    ref: [
      [B.nise, "Bab 4 — Time Response; anatomi kurva respons beserta seluruh indikator yang dibaca darinya."],
      [B.seborg, "Bab 5 dan 12 — pola respons pada proses nyata beserta penyebab yang lazim di baliknya."],
      [B.shinskey, "Bab 1-3 — pengalaman lapangan membaca trend; banyak pola yang tidak muncul di buku teori."],
      [B.isermann, "Bab 2-4 — mengenali gejala kegagalan dari data terukur sebelum kerusakannya membesar."],
  ...
  8: {
    ...
    daring: DARING.kontrol,
    ref: [
      [B.nise, "Bab 6-7 — Stability dan Steady-State Errors; inti pembahasan modul ini."],
      [B.ogata, "Bab 5 — Transient and Steady-State Response Analysis; contoh perhitungan yang setara dengan soal komputasi."],
      [B.franklin, "Bab 4 dan 6 — fungsi sensitivitas serta margin gain dan margin fase."],
      [B.skogestad, "Bab 2-3 — hubungan S + T = 1 dan batas mendasar yang ditimbulkannya."],
      [B.astrom, "Bab 11-12 — penjelasan konseptual mengapa menekan gangguan dan menolak derau tidak dapat dimenangkan bersamaan."],
    ],
  },
  9: {
    ...
    daring: DARING.kontrol,
    ref: [
      [B.astromPid, "Seluruh buku — rujukan paling lengkap tentang PID, termasuk anti-windup dan penyetelan praktis."],
      [B.zn, "Makalah asli Ziegler-Nichols; sumber rumus penyetelan yang dipakai pada modul ini."],
      [B.seborg, "Bab 8-12 — penerapan PID pada proses beserta penanganan dead time."],
      [B.shinskey, "Bab 4-6 — penyetelan di lapangan dan alasan penyetelan buku sering perlu dikoreksi."],
      [B.nise, "Bab 9 — Design via Root Locus; melihat pengaruh tiap suku PID pada letak pole."],
    ],
  },
  10: {
    ...
    ref: [
      ...
      [B.nise, "Bab 5 — Signal-Flow Graphs and Mason's Rule; penyajian paling terstruktur untuk pemula."],
      [B.ogata, "Bab 3 — penyederhanaan diagram blok sebagai pembanding jalur penyelesaian."],
      [B.dorf, "Bab 2 — contoh sistem bertingkat yang loopnya bersilang; kasus tempat Mason benar-benar menghemat waktu."],
      [B.franklin, "Bab 3 — pemodelan sistem bertingkat beserta cara memeriksa hasil penurunannya."],
    ],
  },
  11: {
    ...
    ref: [
      [B.passino, "Bab 1-2 — posisi kendali fuzzy di antara metode lain beserta alasan pemakaiannya."],
      ...
      [B.astrom, "Bab 1 dan 13 — penjadwalan gain dan kontrol adaptif sebagai batas bawah yang perlu dilewati metode cerdas."],
    ],
  },
  12: {
    ...
    daring: DARING.cerdas,
    ref: [
      [B.haykin, "Bab 1-4 — struktur jaringan, backpropagation, dan generalisasi; dasar seluruh pembahasan modul ini."],
      ...
      [B.goodfellow, "Bab 5 dan 7 — regularisasi dan pemisahan data; bagian yang menentukan model menua atau bertahan."],
  ...
  13: {
    ...
    ref: [
      ...
      [B.passino, "Bab 2-5 — perancangan lengkap controller fuzzy, termasuk penskalaan dan permukaan kendali."],
  ...
  14: {
    ...
    daring: DARING.cerdas,
    ref: [
      [B.goldberg, "Bab 1-4 — seleksi, crossover, mutasi, dan elitisme; dasar seluruh pembahasan modul ini."],
      [B.eiben, "Bab 2-6 — penyetelan parameter algoritma dan penanganan kendala secara sistematis."],
      [B.fleming, "Survei pemakaian algoritma evolusioner pada sistem kontrol; contoh perumusan fungsi kebugaran."],
      [B.skogestad, "Bab 2-3 — ukuran kinerja yang layak dijadikan fungsi biaya beserta batas yang menyertainya."],
      [B.astromPid, "Bab 6-7 — pembanding hasil optimasi terhadap penyetelan PID yang baik; uji kelayakan yang wajib dilakukan."],
    ],
  },
};
