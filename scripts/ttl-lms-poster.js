...
(function () {
  ...
  const PLAN = [
    ...
    { sec: 10, id: 110272, p: 9, tipe: "TMK", tgl: "2026-11-21", modul: 8, judul: "Sistem Tenaga Listrik Saluran Transmisi" },
    ...
    { sec: 16, id: 110278, p: 15, tipe: "TMK", tgl: "2027-01-02", modul: 14, judul: "Metode Analisis Aliran Daya (Load Flow)" },
