...
export const MATERI = {
  2: {
    ...
    derivation: {
      ...
      steps: [
        ["Model baku orde dua", "T(s) = wn^2/(s^2 + 2*zeta*wn*s + wn^2)", "Dua parameter, yaitu rasio redaman z dan frekuensi alami wn, menentukan seluruh karakter respons."],
        ["Overshoot dari redaman", "M_p = exp(-pi*zeta/sqrt(1-zeta^2))", "Overshoot hanya bergantung pada z, sama sekali tidak pada wn. Inilah alasan overshoot disetel lebih dulu."],
        ["Redaman dari overshoot", "zeta = -ln(M_p)/sqrt(pi^2 + ln(M_p)^2)", "Membalik hubungan sebelumnya sehingga batas overshoot langsung memberi nilai z minimum."],
        ["Settling time menentukan wn", "t_s ~ 4/(zeta*wn)  =>  wn ~ 4/(zeta*t_s)", "Setelah z diketahui, tuntutan kecepatan menetapkan wn. Kriteria 4/(z*wn) memakai pita dua persen."],
        ["Letak pole yang dituju", "s = -zeta*wn +/- j*wn*sqrt(1-zeta^2)", "Pasangan pole inilah sasaran perancangan; bagian nyata mengatur peluruhan, bagian imajiner mengatur osilasi."],
      ],
    ...
    worked: {
      ...
      steps: [
        ["Hitung redaman minimum", "zeta = -ln(0,10)/sqrt(pi^2 + ln(0,10)^2)", "ln(0,10) = -2,3026 sehingga z = 2,3026/sqrt(9,8696 + 5,3020) = 2,3026/3,8951 = 0,591"],
        ["Hitung frekuensi alami", "wn = 4/(zeta*t_s) = 4/(0,591*2)", "Diperoleh wn = 3,384 rad/s."],
  ...
  3: {
    ...
    worked: {
      ...
      steps: [
        ...
        ["Baca jenis respons", "zeta = 2/sqrt(13) = 0,5547", "Rasio redaman di antara nol dan satu, jadi respons berupa osilasi teredam dengan overshoot."],
  ...
  5: {
    ...
    worked: {
      ...
      steps: [
        ...
        ["Hitung rasio redaman", "zeta = b/(2*sqrt(k*m)) = 12/(2*sqrt(100)) = 0,6", "Nilai di antara nol dan satu, jadi respons berosilasi teredam."],
        ["Cari pole", "s = -zeta*wn +/- j*wn*sqrt(1-zeta^2) = -3 +/- j4", "Bagian nyata -3 memberi konstanta waktu peluruhan 1/3 detik."],
  ...
  6: {
    deep: [
      ...
      },
      {
        ...
        formula: "integral: I += Ki*e*T   |   turunan: D = Kd*(e - e_lalu)/T, wajib difilter",
      },
      {
      ...
      },
      {
        ...
        formula: "f_N = f_s/2   |   filter harus analog, sebelum sampling",
      },
      {
    ...
    derivation: {
      ...
      closing: "Bentuk kenaikan lebih disukai pada penerapan industri karena perpindahan mode menjadi mulus dengan sendirinya dan pembatasan keluaran sekaligus berperan sebagai anti-windup. Aksi turunan pada kedua bentuk tetap memerlukan filter agar derau sensor tidak diperkuat.",
    },
    worked: {
      ...
      answer: "Waktu sampling 0,01 detik memadai: cukup rapat sehingga susut fase akibat penahanan hanya sekitar 1,4 derajat, dan tidak terlalu rapat sehingga aksi turunan tidak memperkuat derau secara berlebihan. Filter turunan dengan frekuensi potong sekitar sepuluh kali bandwidth tertutup dapat ditambahkan tanpa mengganggu kinerja.",
    },
    pitfalls: [
  ...
  7: {
    deep: [
      ...
      },
      {
        ...
        body: [
          ...
          "Struktur dua derajat kebebasan memungkinkan keduanya disetel terpisah. Jalur umpan balik disetel untuk penolakan gangguan dan kestabilan, sementara jalur setpoint diberi filter atau bobot tersendiri untuk membentuk respons pengikutan tanpa mengubah sifat loop.",
        ],
    ...
    derivation: {
      ...
      steps: [
        ["Respons step orde dua", "y(t) = 1 - exp(-zeta*wn*t)*(cos(wd*t) + (zeta/sqrt(1-zeta^2))*sin(wd*t))", "Bentuk baku dengan wd = wn*sqrt(1-z^2)."],
        ["Cari puncak pertama", "dy/dt = 0 pada t_p = pi/wd", "Turunan bernilai nol pertama kali setelah t = 0 pada setengah periode teredam."],
        ["Nilai pada puncak", "y(t_p) = 1 + exp(-zeta*pi/sqrt(1-zeta^2))", "Substitusi t_p ke persamaan respons."],
        ["Definisi overshoot", "M_p = exp(-zeta*pi/sqrt(1-zeta^2))", "Selisih puncak terhadap nilai akhir, dinyatakan relatif."],
        ["Balik hubungannya", "zeta = -ln(M_p)/sqrt(pi^2 + ln(M_p)^2)", "Overshoot terukur langsung memberi rasio redaman."],
        ["Lengkapi dengan periode", "wd = 2*pi/T_osilasi,  wn = wd/sqrt(1-zeta^2)", "Jarak antarpuncak pada grafik memberi frekuensi teredam."],
      ],
    ...
    worked: {
      ...
      steps: [
        ...
        ["Hitung rasio redaman", "zeta = -ln(0,25)/sqrt(pi^2 + ln(0,25)^2)", "ln(0,25) = -1,3863 sehingga z = 1,3863/sqrt(9,8696+1,9218) = 1,3863/3,4340 = 0,404"],
        ...
        ["Perkirakan waktu menetap", "t_s ~ 4/(zeta*wn) = 4/(0,404*5,724) = 1,73 s", "Kriteria pita dua persen."],
      ],
    ...
    deep: [
      {
        ...
        formula: "T(s) = wn^2/(s^2 + 2*zeta*wn*s + wn^2)   |   zeta mengatur bentuk, wn mengatur kecepatan",
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "Struktur dua derajat kebebasan memungkinkan keduanya disetel terpisah. Jalur umpan balik disetel untuk penolakan gangguan dan kestabilan, sementara jalur setpoint diberi filter atau pembobotan tersendiri untuk membentuk respons pengikutan tanpa mengubah sifat loop.",
        ],
      ...
      },
      {
        ...
        formula: "zeta kira-kira PM/100   |   fase dead time = -w*L, membesar terhadap frekuensi",
      },
      {
  ...
  9: {
    deep: [
      {
        ...
        body: [
          ...
          "Aksi turunan bereaksi terhadap laju perubahan error, sehingga ia mulai menahan sebelum keluaran melewati setpoint. Aksi ini menambah redaman dan memungkinkan penguatan proporsional yang lebih besar dipakai dengan aman. Kelemahannya ia memperkuat derau, sehingga hampir selalu memerlukan filter.",
        ],
      ...
      },
      {
        ...
        body: [
          ...
          "Aksi turunan ditambahkan terakhir, dan hanya bila diperlukan. Ia dinaikkan sampai peredaman membaik namun berhenti sebelum actuator mulai bergetar. Bila getaran muncul sebelum peredaman terasa membaik, filternya yang perlu diperbaiki, bukan penguatannya yang diturunkan.",
        ],
    ...
    worked: {
      ...
      steps: [
        ["Rasio redaman dari overshoot", "zeta = -ln(0,10)/sqrt(pi^2 + ln(0,10)^2) = 0,5912", "Batas overshoot menetapkan z."],
        ["Frekuensi alami dari waktu menetap", "wn = 4/(zeta*t_s) = 4/(0,5912*4) = 1,6917", "Tuntutan kecepatan menetapkan wn."],
        ["Hitung Ki", "Ki = tau*wn^2/K = 5*2,8619/2 = 7,1547", "Memakai hasil pencocokan suku konstanta."],
        ["Hitung Kp", "Kp = (2*zeta*wn*tau - 1)/K = (2*0,5912*1,6917*5 - 1)/2", "Memakai hasil pencocokan koefisien s."],
