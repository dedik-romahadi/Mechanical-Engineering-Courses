...
for (const course of courses) {
  for (let moduleNumber = 1; moduleNumber <= 14; moduleNumber += 1) {
    ...
    const checks = [
      ...
      [style.includes("#page-modul .tbl-wrap table.academic-data-table.has-equation-column{table-layout:fixed") && style.includes("--equation-column-width,38%"), "kolom persamaan lebih lebar"],
      [style.includes("#page-modul .tbl-wrap table.academic-data-table .table-caption{caption-side:top") && style.includes("#page-modul .tbl-wrap table.academic-data-table tbody tr:hover td"), "format tabel modern academic seragam"],
